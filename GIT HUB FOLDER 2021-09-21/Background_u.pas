...
procedure TfrmBackground.Button2Click(Sender: TObject);
begin
  ShownForm.Hide;
  frmViewDrivers.Show;
...
procedure TfrmBackground.Button3Click(Sender: TObject);
begin
  ShownForm.Hide;
...
procedure TfrmBackground.Button4Click(Sender: TObject);
begin
  ShownForm.Hide;
...
procedure TfrmBackground.Button5Click(Sender: TObject);
begin
...
begin
  //testing componenets (DBHI)
    //DBHI
  bDarkMode := False; //Testing Dark Mode
  ...
  Begin
    ...
    ClientHeight := 600;
    ClientWidth := 1100;
    Caption := 'The Ferrari Driver Foundation of South Africa';
